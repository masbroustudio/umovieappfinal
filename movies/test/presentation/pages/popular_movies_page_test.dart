...
void main() {
  ...
  testWidgets('Popular Movies should display ListView when data is loaded',
      (WidgetTester tester) async {
    when(() => mockPopularMoviesBloc.state).thenReturn(
      PopularMoviesHasData(const [testMovie]),
    );
  ...
  testWidgets('Popular Movies should display center progress bar when loading',
      (WidgetTester tester) async {
    when(() => mockPopularMoviesBloc.state).thenReturn(
  ...
  testWidgets('Popular Movies Should display text with message when Error',
      (WidgetTester tester) async {
    when(() => mockPopularMoviesBloc.state).thenReturn(
